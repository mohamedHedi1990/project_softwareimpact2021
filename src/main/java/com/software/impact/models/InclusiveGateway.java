...
public class InclusiveGateway extends Event {
        ...
        incomingList.forEach(s -> {
            ...
            if(task != null){
                ...
                events.forEach(event -> {
                    if(event instanceof InclusiveGateway && ((InclusiveGateway) event).getId().equals(s)){
                        incomingTasks.addAll(getIncomingAllTask(taskList,((InclusiveGateway) event).getIncomingList(), events) );
